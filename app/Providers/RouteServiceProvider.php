...
class RouteServiceProvider extends ServiceProvider
{
    ...
    /**
     * Define the "haulier" routes for the application.
     *
     * These routes all receive session state, CSRF protection, etc.
     *
     * @return void
     */
    protected function mapHaulierRoutes()
    {
        Route::group([
            'middleware' => ['web', 'haulier', 'auth:haulier'],
            'prefix' => 'haulier',
            'as' => 'haulier.',
            'namespace' => $this->namespace,
        ], function ($router) {
            require base_path('routes/haulier.php');
        });
    }
